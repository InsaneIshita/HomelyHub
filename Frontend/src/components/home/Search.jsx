...
const Search = () => {
  ...
  return (
    <div className='searchbar'>
        <input className='search' id='search_destination' type="text" placeholder='Search destination'
        value={keyword.city}
        ...
        <Space direction="vertical" size={12} className='search'>
            ...
            <input className='search' id='addguest' type="number" placeholder='Add Guests'
